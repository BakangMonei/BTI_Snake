package com.neizathedev.breakingtheice.Type4Health;
...
public class HealActivity extends AppCompatActivity {
    ...
    private static final String FILE_NAME = "Healing.docx";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() { // from class: com.neizathedev.breakingtheice.Type4Health.HealActivity$$ExternalSyntheticLambda0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                HealActivity.this.m355x9c3de2e2(view);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: lambda$onCreate$0$com-neizathedev-breakingtheice-Type4Health-HealActivity  reason: not valid java name */
    public /* synthetic */ void m355x9c3de2e2(View v) {
    ...
    private void downloadFile() {
        ...
        this.mStorageRef.child(FILE_NAME).getDownloadUrl().addOnCompleteListener(new OnCompleteListener() { // from class: com.neizathedev.breakingtheice.Type4Health.HealActivity$$ExternalSyntheticLambda1
            @Override // com.google.android.gms.tasks.OnCompleteListener
            public final void onComplete(Task task) {
                HealActivity.this.m354x48a2568c(localFile, task);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: lambda$downloadFile$1$com-neizathedev-breakingtheice-Type4Health-HealActivity  reason: not valid java name */
    public /* synthetic */ void m354x48a2568c(File localFile, Task task) {
        if (task.isSuccessful()) {
            ...
            NotificationCompat.Builder builder = new NotificationCompat.Builder(this, CHANNEL_ID).setSmallIcon(R.drawable.ic_download).setContentTitle("Downloading Healing.docx").setContentText("Download in progress").setPriority(1).setProgress(0, 0, true);
