...
public class DepressionActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() { // from class: com.neizathedev.breakingtheice.Type2MentalHealth.DepressionActivity$$ExternalSyntheticLambda0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                DepressionActivity.this.m339x423ff5d9(view);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: lambda$onCreate$0$com-neizathedev-breakingtheice-Type2MentalHealth-DepressionActivity  reason: not valid java name */
    public /* synthetic */ void m339x423ff5d9(View v) {
    ...
    private void downloadFile() {
        ...
        this.mStorageRef.child(FILE_NAME).getDownloadUrl().addOnCompleteListener(new OnCompleteListener() { // from class: com.neizathedev.breakingtheice.Type2MentalHealth.DepressionActivity$$ExternalSyntheticLambda1
            @Override // com.google.android.gms.tasks.OnCompleteListener
            public final void onComplete(Task task) {
                DepressionActivity.this.m338xb7923a83(localFile, task);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: lambda$downloadFile$1$com-neizathedev-breakingtheice-Type2MentalHealth-DepressionActivity  reason: not valid java name */
    public /* synthetic */ void m338xb7923a83(File localFile, Task task) {
