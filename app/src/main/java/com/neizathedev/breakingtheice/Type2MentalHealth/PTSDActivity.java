...
public class PTSDActivity extends AppCompatActivity {
    ...
    private static final String FILE_NAME = "PTSD.docx";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() { // from class: com.neizathedev.breakingtheice.Type2MentalHealth.PTSDActivity$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                PTSDActivity.this.m347xa1e884a8(view);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: lambda$onCreate$0$com-neizathedev-breakingtheice-Type2MentalHealth-PTSDActivity  reason: not valid java name */
    public /* synthetic */ void m347xa1e884a8(View v) {
    ...
    private void downloadFile() {
        ...
        this.mStorageRef.child(FILE_NAME).getDownloadUrl().addOnCompleteListener(new OnCompleteListener() { // from class: com.neizathedev.breakingtheice.Type2MentalHealth.PTSDActivity$$ExternalSyntheticLambda0
            @Override // com.google.android.gms.tasks.OnCompleteListener
            public final void onComplete(Task task) {
                PTSDActivity.this.m346xce10d2(localFile, task);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: lambda$downloadFile$1$com-neizathedev-breakingtheice-Type2MentalHealth-PTSDActivity  reason: not valid java name */
    public /* synthetic */ void m346xce10d2(File localFile, Task task) {
        if (task.isSuccessful()) {
            ...
            NotificationCompat.Builder builder = new NotificationCompat.Builder(this, CHANNEL_ID).setSmallIcon(R.drawable.ic_download).setContentTitle("Downloading PTSD.docx").setContentText("Download in progress").setPriority(1).setProgress(0, 0, true);
