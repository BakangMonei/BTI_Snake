package com.neizathedev.breakingtheice.Type5Trouble;
...
public class AddictionActivity extends AppCompatActivity {
    ...
    private static final String FILE_NAME = "ADDICTION.docx";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() { // from class: com.neizathedev.breakingtheice.Type5Trouble.AddictionActivity$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                AddictionActivity.this.m357x38f1641(view);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: lambda$onCreate$0$com-neizathedev-breakingtheice-Type5Trouble-AddictionActivity  reason: not valid java name */
    public /* synthetic */ void m357x38f1641(View v) {
    ...
    private void downloadFile() {
        ...
        this.mStorageRef.child(FILE_NAME).getDownloadUrl().addOnCompleteListener(new OnCompleteListener() { // from class: com.neizathedev.breakingtheice.Type5Trouble.AddictionActivity$$ExternalSyntheticLambda0
            @Override // com.google.android.gms.tasks.OnCompleteListener
            public final void onComplete(Task task) {
                AddictionActivity.this.m356x6274a26b(localFile, task);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: lambda$downloadFile$1$com-neizathedev-breakingtheice-Type5Trouble-AddictionActivity  reason: not valid java name */
    public /* synthetic */ void m356x6274a26b(File localFile, Task task) {
        if (task.isSuccessful()) {
            ...
            NotificationCompat.Builder builder = new NotificationCompat.Builder(this, CHANNEL_ID).setSmallIcon(R.drawable.ic_download).setContentTitle("Downloading ADDICTION.docx").setContentText("Download in progress").setPriority(1).setProgress(0, 0, true);
